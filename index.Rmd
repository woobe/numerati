...
# New Models
models_new_g1 <- c(paste0("i_like_the_coin_", stringr::str_pad(6:15, 2, pad = "0")))
...
models_new_g4 <- c("ia_ai", "i_like_the_coin_06", paste0("u_pump_i_pump_", stringr::str_pad(1:5, 2, pad = "0")))
...
# Combine list
ls_username <- c(models_legacy_02,
                 models_new_g1,
                 models_new_g2,
                 models_new_g3,
                 models_new_g4,
...
# ls_username <- as.character(unique(ls_username)) 
