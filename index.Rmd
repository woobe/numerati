...
# Legacy Models (CORR + MMC)
g_legacy_01_cm <-
  ggplot(d_new[Username %in% models_legacy_01]) +
...
# New Models
models_new_g1 <- c(paste0("i_like_the_coin_", stringr::str_pad(6:10, 2, pad = "0")))
...
models_new_g4 <- c("ia_ai", "i_like_the_coin_06", "the_hodler_01",
...
<a href="https://numer.ai/i_like_the_coin_06" target="_blank"><img src="./img/i_like_the_coin_256.png" width="12.5%"></a>
<a href="https://numer.ai/u_pump_i_pump_04" target="_blank"><img src="./img/u_pump_i_pump_256.png" width="12.5%"></a>
...
```{r, echo=FALSE, out.width="95%", warning=FALSE, message=FALSE}
ggplotly(g_legacy_01_cm) %>% config(displayModeBar = FALSE)
```
